...
class MailRecipient(models.Model):
    ...
    name = models.CharField(
        max_length=200, verbose_name="Имя", help_text="Введите ваше имя"
    )
    middle_name = models.CharField(
        max_length=200, verbose_name="Отчество", help_text="Введите ваше отчество"
    )
    last_name = models.CharField(
        max_length=200, verbose_name="Фамилия", help_text="Введите вашу фамилию"
    )
