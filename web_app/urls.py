...
urlpatterns = [
    ...
    path(
        "web_app/recipient_list/",
        MailRecipientListView.as_view(),
        name="recipient_list",
    ),
    path("web_app/create/", MailRecipientCreateView.as_view(), name="recipient_create"),
    path(
        "web_app/<int:pk>/", MailRecipientDetailView.as_view(), name="recipient_detail"
    ),
    path(
        "web_app/<int:pk>/update/",
        MailRecipientUpdateView.as_view(),
        name="recipient_update",
    ),
    path(
        "web_app/<int:pk>/delete/",
        MailRecipientDeleteView.as_view(),
    ...
    path(
        "web_app/message/<int:pk>/", MessageDetailView.as_view(), name="message_detail"
    ),
    path(
        "web_app/message/<int:pk>/update/",
        MessageUpdateView.as_view(),
        name="message_update",
    ),
    path(
        "web_app/message/<int:pk>/delete/",
    ...
    path(
        "web_app/mailing/<int:pk>/", MailingDetailView.as_view(), name="mailing_detail"
    ),
    path(
        "web_app/mailing/<int:pk>/update/",
        MailingUpdateView.as_view(),
        name="mailing_update",
    ),
    path(
        "web_app/mailing/<int:pk>/delete/",
        MailingDeleteView.as_view(),
        name="mailing_delete",
    ),
    path(
        "web_app/mailing/<int:pk>/start/",
