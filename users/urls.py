...
from users.views import RegisterView, confirm_email, reset_password, UserLoginView, UserLogoutView

app_name = 'users'

urlpatterns = [
    path('login/', UserLoginView.as_view(template_name='users/login.html', form_class=StyledLoginForm), name='login'),
